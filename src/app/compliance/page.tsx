  ...
  const sections = [
    {
      ...
      icon: Shield,
      content: [
        '7connect berkomitmen untuk melindungi data pelanggan kami dengan standar keamanan tertinggi',
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              7connect berkomitmen untuk memenuhi standar keamanan dan kepatuhan tertinggi.
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">compliance@7connect.id</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
