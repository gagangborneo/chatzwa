...
const ContactPage = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      description: 'Tech Hub, SCBD'
    }
  ]

  const stats = [
    { icon: Users, label: 'Pelanggan Puas', value: '10.000+' },
    { icon: MessageCircle, label: 'Support Tickets', value: '99% Kepuasan' },
    { icon: Clock, label: 'Waktu Respons', value: '< 2 jam' }
  ]
