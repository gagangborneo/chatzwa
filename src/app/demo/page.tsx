...
const DemoPage = () => {
  ...
  const embedCode = `<!-- 7connect Embed Chat Widget -->
<script>
  window.EMBED_CHAT_CONFIG = {
    ...
    welcomeMessage: "Halo! Selamat datang di demo 7connect. Ada yang bisa saya bantu?",
...
<!-- End 7connect Embed Chat Widget -->`
  ...
  const platforms = [
    {
      name: 'WordPress',
      icon: '📝',
      description: 'Install plugin 7connect dari WordPress repository',
      steps: [
        'Search "7connect Chat" in WordPress plugins',
    ...
    },
    {
      ...
      steps: [
        'Install via npm: npm install 7connect-embed',
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'Our customer satisfaction increased by 40% after implementing the 7connect chat widget.',
      rating: 5
    },
    {
      name: 'Mike Johnson',
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Lihat bagaimana 7connect embed chat bekerja dan meningkatkan customer experience
            </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses using 7connect to provide exceptional customer support
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/dashboard">
                <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-xl">
