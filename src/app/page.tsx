...
export const metadata: Metadata = {
  title: "7 Connect - Platform Chatbot AI Indonesia | Solusi Bisnis Digital",
  ...
  keywords: ["Platform Chatbot AI", "AI Indonesia", "Customer Service", "Otomasi Bisnis", "WhatsApp Bot", "7 Connect"],
  openGraph: {
