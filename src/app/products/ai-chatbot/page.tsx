...
const AIChatbotPage = () => {
  ...
  const testimonials = [
    {
      ...
      content: 'AI chatbot Chatzwa mengubah cara kami melayani pelanggan. Respon waktu turun drastis dan kepuasan pelanggan meningkat signifikan!',
      rating: 5
    },
    {
      name: 'Budi Santoso',
  ...
  const faqs = [
    {
      question: 'Bagaimana cara kerja AI chatbot Chatzwa?',
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Bergabunglah dengan ratusan bisnis yang sudah merasakan manfaat AI chatbot Chatzwa
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
