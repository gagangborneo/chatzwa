...
const WordPressPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Connect dengan 7connect platform menggunakan API key yang simple'
    },
    {
      icon: Palette,
  ...
  const installationSteps = [
    {
      ...
      description: 'Download 7connect Chatbot Plugin dari WordPress.org atau dashboard kami',
      icon: Download,
      details: [
        'Go to WordPress.org/plugins/7connect-chatbot',
    ...
    },
    {
      ...
      details: [
        ...
        'Go to 7connect Chatbot settings',
    ...
    },
    {
      ...
      description: 'Hubungkan dengan 7connect platform menggunakan API key',
      icon: Key,
      details: [
        'Get API key dari 7connect dashboard',
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Anda bisa signup gratis di 7connect platform untuk mendapatkan API key. Setelah signup, Anda akan mendapatkan dashboard access untuk generate API keys.'
    },
    {
