  ...
  const sections = [
    {
      ...
      icon: CheckCircle,
      content: [
        'Dengan mendaftar dan menggunakan layanan Chatzwa, Anda menyetujui untuk terikat oleh syarat dan ketentuan ini',
    ...
    },
    {
      ...
      icon: FileText,
      content: [
        'Chatzwa adalah platform CPaaS (Communications Platform as a Service) yang menyediakan layanan chatbot AI dan komunikasi digital',
    ...
    },
    {
      ...
      icon: Shield,
      content: [
        'Semua hak kekayaan intelektual layanan milik Chatzwa atau pemberi lisensi kami',
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Syarat dan ketentuan ini mengatur penggunaan layanan Chatzwa.
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-700 leading-relaxed">
                      Syarat dan ketentuan ini mengikat secara hukum. Dengan mendaftar dan menggunakan layanan Chatzwa,
