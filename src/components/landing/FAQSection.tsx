...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "Apa itu 7connect?",
      answer: "7connect adalah platform CPaaS (Communications Platform as a Service) yang menyediakan solusi chatbot AI untuk WhatsApp. Kami membantu bisnis mengotomasi layanan pelanggan dengan AI yang cerdas dan responsif.",
      icon: MessageCircle
    },
    {
    ...
    {
      question: "Apakah 7connect aman untuk data bisnis?",
    ...
    {
      question: "Berapa biaya untuk menggunakan 7connect?",
    ...
    },
    {
      ...
      answer: "7connect mudah diintegrasikan dengan sistem CRM, website, dan aplikasi yang sudah Anda gunakan melalui API yang komprehensif. Tim kami juga membantu proses integrasi jika diperlukan.",
      icon: Globe
    },
    {
    ...
    {
      question: "Bagaimana cara memulai menggunakan 7connect?",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Temukan jawaban untuk pertanyaan umum tentang 7connect dan layanan kami
          </p>
        </div>
          ...
          <Card className="bg-gradient-to-r from-green-600 to-emerald-600 border-0 shadow-2xl max-w-2xl mx-auto">
            <CardContent className="p-12">
              ...
              <p className="text-xl text-green-100 mb-8">
                Tim support kami siap membantu Anda menjawab semua pertanyaan tentang 7connect
              </p>
