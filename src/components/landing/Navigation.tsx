  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Chatzwa</span>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link href="/dashboard">
                <Button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl shadow-lg hover:shadow-green-500/25">
                  {t('nav.getStarted')}
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="lg:hidden border-t bg-white/95 border-gray-200 backdrop-blur-md">
